...
class ComputerEasyGameScreen extends StatefulWidget {
  const ComputerEasyGameScreen({Key? key});

  @override
  State<ComputerEasyGameScreen> createState() =>
      _ComputerEasyGameScreenState();
}

class _ComputerEasyGameScreenState extends State<ComputerEasyGameScreen> {
